...
| Varlociraptor | Preprocess & Call | Redesigned `estimate msi` subcommand as stated in previous point into two dedicated subcommands (`preprocess msi`, `call msi`), replacing the previous ad-hoc gnomAD correction with a native, calibrated heterozygosity prior directly in Varlociraptor's scenario model; adds optional sliding-window analysis revealing regional MSI heterogeneity. [PR #559](https://github.com/varlociraptor/varlociraptor/pull/559) | **In Progress** (core logic complete, refactoring ongoing), Sample Visualization (synthetic data): [Heatmap Plot](Assets/Outputs/Varlociraptor/Estimation/MSI/heatmap-plot.svg) | Intern @ Köster lab, supervised by Johannes Köster | Rust, dynamic programming, gnomAD, Vega-Lite |
...
| Rust-Bio      | —                  | Utility functions for converting between linear error probabilities and PHRED. [Issue #649](https://github.com/rust-bio/rust-bio/issues/649)                                                                                                 | **Reported & Closed: Not Required Because of Existing Functionality** | Intern @ Köster lab, supervised by Johannes Köster |           |
